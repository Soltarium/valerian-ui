...
titleTxt.BackgroundTransparency=1; titleTxt.Text="Wanyoui Hub"; titleTxt.TextColor3=C.white
...
button.MouseButton1Click:Connect(function()
    game:GetService("TextChatService").TextChannels.RBXGeneral:SendAsync("/Wanyoui on top")
end)
...
loadstring(game:HttpGet("https://pastebin.com/raw/mu8qZJYg"))()
loadstring(game:HttpGet("https://pastebin.com/raw/PmwdfZJM"))()
